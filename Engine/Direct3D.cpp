...
HRESULT Direct3D::InitShaderNormalMap()
{
	...
	//頂点インプットレイアウト
	D3D11_INPUT_ELEMENT_DESC layout[] = {
		{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0},	//位置
		{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT,    0},	//UV
		{ "NORMAL",	  0, DXGI_FORMAT_R32G32B32_FLOAT, 0},	//法線
		{ "TANGENT",  0, DXGI_FORMAT_R32G32B32_FLOAT, 0},	//法線
	};
